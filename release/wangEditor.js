...
}, defineProperty(_config, 'uploadFileName', ''), defineProperty(_config, 'uploadVideoParams', {
    // token: 'abcdef12345'
}), defineProperty(_config, 'uploadVideoHeaders', {
    // 'Accept': 'text/x-json'
}), defineProperty(_config, 'withCredentials', false), defineProperty(_config, 'uploadVideoTimeout', 10000), defineProperty(_config, 'uploadVideoHooks', {
    // customInsert: function (insertLinkImg, result, editor) {
    //     console.log('customInsert')
...
}), defineProperty(_config, 'qiniu', false), _config);
...
Video.prototype = {
    ...
    _createPanel: function _createPanel() {
        ...
        var btnId = getRandom('btn');
        var upVideoTriggerId = getRandom('up-trigger');
        var upVideoFileId = getRandom('up-file');
...
UploadVideo.prototype = {
    ...
    insertLinkVideo: function insertLinkVideo(link) {
        ...
        video.onerror = function () {
            video = null;
            // 无法成功下载视频
            _this2._alert('插入视频错误', 'wangEditor: \u63D2\u5165\u89C6\u9891\u51FA\u9519\uFF0C\u89C6\u9891\u94FE\u63A5\u662F "' + link + '"\uFF0C\u4E0B\u8F7D\u8BE5\u94FE\u63A5\u5931\u8D25');
            return;
        };
    ...
    uploadVideo: function uploadVideo(files) {
        ...
        var uploadVideoShowBase64 = config.uploadVideoShowBase64;
        ...
        var timeout = config.uploadVideoTimeout || 3000;
        var withCredentials = config.withCredentials;
        if (withCredentials == null) {
            withCredentials = false;
        }
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.readyState === 4) {
                    if (xhr.status < 200 || xhr.status >= 300) {
                        ...
                        // xhr 返回状态错误
                        _this3._alert('上传视频发生错误', '\u4E0A\u4F20\u89C6\u9891\u53D1\u751F\u9519\u8BEF\uFF0C\u670D\u52A1\u5668\u8FD4\u56DE\u72B6\u6001\u662F ' + xhr.status);
                        return;
                    }
